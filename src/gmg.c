...
void line_gauss_seidel_x(gmg_t *gmg, int lev, int iter)
{
  ...
  int kbeg, kend, kstep, jbeg, jend, jstep;
  if(iter%2==1){
    kbeg = n3-1; kend = 0;  kstep = -1;
    jbeg = n2-1; jend = 0;  jstep = -1;
  }else{
...
void line_gauss_seidel_y(gmg_t *gmg, int lev, int iter)
{
  ...
  int kbeg, kend, kstep, ibeg, iend, istep;
  if(iter%2==1){
    kbeg = n3-1; kend = 0;  kstep = -1;
    ibeg = n1-1; iend = 0;  istep = -1;
  }else{
...
void line_gauss_seidel_z(gmg_t *gmg, int lev, int iter)
{
  ...
  int jbeg, jend, jstep, ibeg, iend, istep;
  if(iter%2==1){
    jbeg = n2-1; jend = 0;  jstep = -1;
    ibeg = n1-1; iend = 0;  istep = -1;
  }else{
