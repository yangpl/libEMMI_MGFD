...
{
    return (_Complex float*)realloc1(v,n1,sizeof(_Complex float));
}
...
{
    return (_Complex float**)alloc2(n1,n2,sizeof(_Complex float));
}
...
{
    return (_Complex float***)alloc3(n1,n2,n3,sizeof(_Complex float));
}
...
{
    return (_Complex float****)alloc4(n1,n2,n3,n4,sizeof(_Complex float));
}
